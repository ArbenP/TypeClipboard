...
final class ClipboardViewModel: ObservableObject {
    ...
    @Published var shiftReturnForNewlines: Bool = false
    ...
    func typeBuffer() {
        ...
        let shiftReturnForNewlines = self.shiftReturnForNewlines
        ...
        typingTask = Task { @MainActor [weak self] in
            ...
            do {
                ...
                try Task.checkCancellation()
                try await self.typingEngine.type(text: text, characterDelay: delay, appendReturn: appendReturn, shiftReturnForNewlines: shiftReturnForNewlines)
